...
namespace masivotech\mobbernTCP\migrations\v31x;
...
class release_3_1_0 extends \phpbb\db\migration\migration
{
  ...
  public function update_data()
  {
    return array(
      ...
      array('config.add', array('mbrn_menuLink4', '')),
      array('config.add', array('mbrn_menuLinkUrl4', '')),
      array('config.add', array('mbrn_menuLinkIcon4', 'fa-star')),
