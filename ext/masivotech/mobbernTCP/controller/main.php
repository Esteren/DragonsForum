...
namespace masivotech\mobbernTCP\controller;
...
class main
{
  ...
  /* @var \masivotech\mobbernTCP\controller\settings */
  protected $settings;
  ...
  * @param \masivotech\mobbernTCP\controller\settings  $settings   Settings object
  */
  public function __construct(\phpbb\auth\auth $auth, \phpbb\config\config $config, \phpbb\template\template $template, \phpbb\user $user, \phpbb\controller\helper $helper, $root_path, $php_ext, \masivotech\mobbernTCP\controller\settings $settings)
  {
    $this->auth = $auth;
    $this->config = $config;
